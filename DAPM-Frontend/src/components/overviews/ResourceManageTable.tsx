...
interface ResourceManageTableProps {
    selectedResource: Resource | null;
}

export default function ResourceManageTable({ selectedResource }: ResourceManageTableProps) {
        ...
        const fetchUsersData = async () => {
            try {
                if (selectedResource) {
                    ...
                    const usersForResource = allUsers.filter((user: { id: any; }) =>
    ...
    function handleRemove(id: string): void {
        if (selectedResource) {
            removeUserResource(id, selectedResource.resourceId);
        ...
        <Box data-qa = "resourceManager-user-table"
            ...
            {selectedResource ? (
                                ...
                                {currentUsers.length === 0 && (
                                    <TableRow>
                                        <TableCell colSpan={5} align="center">
                                            No users found for the selected resource.
                                        </TableCell>
                                    </TableRow>
                                )}
                            </TableBody>
                ...
                <Typography variant="h6" align="center">
                    Please select a resource to view its users.
                </Typography>
            )}
        </Box>
    );
